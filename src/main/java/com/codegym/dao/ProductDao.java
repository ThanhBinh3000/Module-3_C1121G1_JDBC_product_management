...
public class ProductDao implements IProductDao {
    ...
    public static final String SQL_UPDATE_PRODUCT = "UPDATE product SET name = ?, price = ?, description = ? where  id = ?";
    public static final String SQL_INSERT_PRODUCT = "INSERT INTO product (name, price, description) values (?, ?, ?)";
